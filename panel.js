(() => {
  ...
  $('#imageDrawSize').addEventListener('change',e=>imageEditorState.pencilSize=Number(e.target.value));$('#imageDrawMode').addEventListener('change',e=>imageEditorState.drawMode=e.target.value);
