(() => {
  ...
  window.addEventListener("load",async()=>{
    try{
      const resetKey="egm-panel-cache-reset-6.36.83";
      ...
      const registration=await navigator.serviceWorker.register("./service-worker-6.36.83.js",{scope:"./",updateViaCache:"none"});
