(() => {
  ...
  window.addEventListener("load",async()=>{
    try{
      const resetKey="egm-panel-cache-reset-6.36.88";
      ...
      const registration=await navigator.serviceWorker.register("./service-worker-6.36.88.js",{scope:"./",updateViaCache:"none"});
